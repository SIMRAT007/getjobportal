...
export default function Feature2() {
  return (
    <div className="bg-[#173a96] p-10 md:p-20 rounded-2xl text-center mt-20 md:mt-40 container">
      <h2 className="text-4xl md:text-7xl font-bold text-white">Leverage global world-class talented people</h2>
      ...
      <div className="mt-8 flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20">
        <div className="bg-white shadow-md p-6 rounded-2xl text-center w-72 md:w-80 flex flex-col items-center">
          <StarIcon className="h-16 w-16 md:h-20 md:w-20 text-[#173a96]" />
        ...
        <div className="bg-white shadow-md p-6 rounded-2xl text-center w-72 md:w-80 flex flex-col items-center">
          <SparklesIcon className="h-16 w-16 text-[#173a96]" />
